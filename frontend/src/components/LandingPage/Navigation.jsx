              ...
              {['Products', 'Solutions', 'Resources', 'Pricing'].map((item, i) => (
                <li key={i}>
                  
                  {
                    ...
                    <div tabIndex={0}  className="text-white mr-2">{item}</div>
                      ...
                      >
                        ...
                        <div className="flex flex-col p-3 gap-3 ">
                          ...
                          {["Screen", "Interview", "Engage", "SkillUp"].map((item, idx) => (
                            <Link 
                              to={`/${item.toLowerCase()}`}
                              key={idx}
                        ...
                        <div className="flex flex-col p-3 gap-3 min-w-[230px]">
                          ...
                          {["Certified Assessments", "Plagiarism Detection", "Real-World Question", "Integration"].map(
                            (item, idx) => (
                              <Link
...

                    {
                      ...
                      >
                        ...
                        <div className="flex flex-col p-3 gap-3 min-w-[260px]">
                          <h3 className="font-semibold text-gray-700 mb-2">What We Do</h3>
...

                    {
                      ...
                      >
                        ...
                        <div className="flex flex-col p-3 gap-3 min-w-[190px]">
                          <h3 className="font-semibold text-gray-700 mb-2">Learn</h3>
                        ...
                        <div className="flex flex-col p-3 gap-3 min-w-[230px]">
                          <h3 className="font-semibold text-gray-700 mb-2">Product Help</h3>
